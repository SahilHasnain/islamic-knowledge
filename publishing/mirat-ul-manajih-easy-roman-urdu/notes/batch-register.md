...
- Source rows: 10
- Ordered range: 1-10
- Arabic hadith fields: preserved from `c9with_araab`
- Export markers: removed from adapted text
- Devanagari: none
- Manuscript limit: under 1,000 lines

## Batch 12 Verification Record

- Source rows: 5
- Ordered range: 81-85
- Source IDs: 208, 210, 212, 214, 215
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
- Manuscript limit: under 1,000 lines in file 02

## Batch 13 Verification Record

- Source rows: 5
- Ordered range: 86-90
- Source IDs: 217, 218, 219, 221, 222
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
- Manuscript limit: Hadith 86-89 in file 02; Hadith 90 in file 03 at a complete boundary

## Batch 14 Verification Record

- Source rows: 5
- Ordered range: 91-95
- Source IDs: 223, 3396, 229, 232, 234
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
- Manuscript limit: under 1,000 lines in file 03

## Batch 17 Verification Record

- Source rows: 5
- Ordered range: 106-110
- Arabic hadith fields: preserved exactly from `with_araab`
- Translation and explanation fields: complete and adapted
- Source translation markers: preserved in place as bold Roman numerals
- Export markers and tab artifacts: removed
- Devanagari: none
- Manuscript line count: 416, under 1,000 lines in file 03

## Batch 18 Verification Record

- Source records: complete Hadith 111-120 extraction in `mirat-111-120-source.md`
- Ordered range: 111-120
- Arabic hadith fields: preserved exactly from `with_araab`
...
- Source rows: 5
- Ordered range: 96-100
- Source IDs: 235, 237, 238, 240, 243
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
## Hadith 91-100 Marker Correction

- Complete `c12translation` fields rechecked for Hadith 91-100.
- All source translation markers were restored in the corresponding Lafzi tarjuma positions as `**1**`, `**2**`, etc.; none were omitted or renumbered.
- Hadith 99's continuation marker was retained.
- Existing literal Roman Urdu wording and Arabic hadith text were not rewritten.

## Batch 08 Verification Record

- Source rows: 5
- Ordered range: 61-65
- Source IDs: 132, 135, 142, 145, 147
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
- Source rows: 5
- Ordered range: 66-70
- Source IDs: 148, 149, 150, 151, 152
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
- Source rows: 5
- Ordered range: 71-75
- Source IDs: 153, 154, 183, 184, 185
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
- Source rows: 5
- Ordered range: 76-80
- Source IDs: 186, 187, 188, 202, 205
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
- Source rows: 10
- Ordered range: 51-60
- Source IDs: 112, 115, 3228, 123, 124, 126, 127, 129, 130, 131
- Arabic hadith fields: preserved exactly from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifacts: removed
- Devanagari: none
...
- Arabic hadith fields: preserved from `c9with_araab`
- Translation and explanation fields: complete and adapted
- Export markers and tab artifact: removed
- Devanagari: none
- Manuscript limit: under 1,000 lines
