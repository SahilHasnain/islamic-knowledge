...
`_archive/batches-83-85/`, `_archive/batches-86/`, `_archive/batches-87-91/`,
and `_archive/batches-92-96/`.
...
| `01-jild-awwal/02-surah-al-baqarah/02-surah-al-baqarah-roman-01.md` + numbered parts | 1 | 1 | Al-Baqarah 2:1–2:131 | 130 | approved | Consolidated from batches 01–96 plus `_inserts/` cross-references (2:36, 2:39, 2:46); each part is at most 1,000 lines; all parts pass validator; every ayat→tafseerId pair matched against DB via `consolidate_siratul_jinan_batches.py`; coverage complete (ayat 2 has no source row) |
