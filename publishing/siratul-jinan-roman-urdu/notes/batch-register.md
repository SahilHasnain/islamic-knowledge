...
| `01-jild-awwal/02-surah-al-baqarah/02-surah-al-baqarah-roman-01.md` + `-02.md` | 1 | 1 | Al-Baqarah 2:1–2:121 | 120 | approved | Consolidated from batches 01–86 plus `_inserts/` cross-references (2:36, 2:39, 2:46); each part is at most 2,000 lines; both parts pass validator; every ayat→tafseerId pair matched against DB via `consolidate_siratul_jinan_batches.py`; coverage complete (ayat 2 has no source row) |
