...
const projectDir = path.join(root, "publishing", "tawakkul-the-missing-peace");
...
const outPath = path.join(outDir, "tawakkul-roman-urdu.html");
...
const digitalPdfPath = path.join(pdfDir, "tawakkul-roman-urdu-digital.pdf");
const printPdfPath = path.join(printDir, "tawakkul-roman-urdu-print.pdf");
const epubPath = path.join(epubDir, "tawakkul-roman-urdu.epub");
const pdfPageSize = {
  width: "148mm",
  height: "210mm",
};
...
const manuscriptFiles = [
  "00-front-matter/01-preface.md",
  "00-front-matter/02-introduction.md",
  "01-chapter-one/01-the-road-and-the-roadblock.md",
  "01-chapter-one/02-the-divine-roadmap.md",
  "02-chapter-two/01-the-ultimate-trust-fall.md",
  "03-chapter-three/01-opening-and-the-well.md",
  "03-chapter-three/02-egypt-and-the-trial.md",
  "03-chapter-three/03-choices-and-insights.md",
  "03-chapter-three/04-return-to-egypt.md",
  "03-chapter-three/05-the-plan-comes-to-light.md",
  "04-chapter-four/01-musa-and-the-mission.md",
  "04-chapter-four/02-testing-times.md",
  "05-chapter-five/01-unlimited-connection.md",
  "05-chapter-five/02-fire-and-ice.md",
  "06-chapter-six/01-noah-and-the-ark.md",
  "06-chapter-six/02-planning-and-the-journey.md",
  "07-chapter-seven/01-meet-the-challenger.md",
  "07-chapter-seven/02-the-real-challenge.md",
  "08-chapter-eight/01-salmans-search.md",
  "08-chapter-eight/02-the-missing-peace.md",
  "09-chapter-nine/01-gratitude-and-choice.md",
  "09-chapter-nine/02-dhikr-and-fikr.md",
  "10-chapter-ten/01-knowledge-and-patience.md",
  "10-chapter-ten/02-reliance-and-preparation.md",
  "11-verses-on-tawakkul/01-verses.md",
];
...
function getTocEntries() {
  ...
  // Front matter
  for (const f of ["00-front-matter/01-preface.md", "00-front-matter/02-introduction.md"]) {
  ...
  const viewFiles = manuscriptFiles.filter((f) => /^\d{2}-chapter-/.test(f));
  ...
  // Back matter
  for (const f of ["11-verses-on-tawakkul/01-verses.md"]) {
    const h = firstHeading(f);
    if (h) items.push({ title: h.text, rawHeading: h.raw, type: "major", hasContent: true });
  }
...
function sectionHtml(md) {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Tawakkul — The Missing Peace in the Journey of Life</title><style>${css}</style></head><body><main class="book">${markdownToHtml(md, tocRawHeadings)}</main></body></html>`;
}
...
const frontMatterHtml = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Tawakkul — The Missing Peace in the Journey of Life</title><style>${css}</style></head><body><main class="book">${titleHtml}${tempTocHtml}</main></body></html>`;
...
<head>
  ...
  <title>Tawakkul — The Missing Peace in the Journey of Life</title>
  <style>${css}</style>
</head>
<body>
  <main class="book">
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1" xml:lang="en">
  <head>
    <meta name="dtb:uid" content="urn:islamic-knowledge:tawakkul-roman-urdu"/>
    <meta name="dtb:depth" content="1"/>
    <meta name="dtb:totalPageCount" content="0"/>
    <meta name="dtb:maxPageNumber" content="0"/>
  </head>
  <docTitle><text>Tawakkul — The Missing Peace in the Journey of Life</text></docTitle>
  <navMap>
${ncxItems}
  </navMap>
</ncx>`);
...
<body><section class="cover-page" style="background:#0b3a2a;height:100vh;"><p style="color:white;text-align:center;padding-top:45vh;font-size:1.8rem;">Tawakkul — The Missing Peace in the Journey of Life</p></section></body>
</html>`);
  addText(zip, "OEBPS/contents.xhtml", `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
<head><title>Tawakkul — The Missing Peace in the Journey of Life</title><link rel="stylesheet" href="styles/book.css" type="text/css"/></head>
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="bookid" xml:lang="en">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    <dc:identifier id="bookid">urn:islamic-knowledge:tawakkul-roman-urdu</dc:identifier>
    <dc:title>Tawakkul — The Missing Peace in the Journey of Life</dc:title>
    <dc:language>en</dc:language>
    <dc:creator>Shaykh Faheem</dc:creator>
...
async function writeDocx() {
  ...
  const docxPath = path.join(docxDir, "tawakkul-roman-urdu.docx");
...
await writePdf({
  ...
  headerTemplate: `<div style="box-sizing: border-box; color: #0f5a3e; font-family: Georgia, 'Times New Roman', serif; font-size: 9px; padding: 6px 16mm 0; text-align: left; width: 100%;">Tawakkul — The Missing Peace in the Journey of Life</div>`,
